...
public class Client implements IGenericEntity {
	...
	public Client(String nom, String prenom, String email, Adresse adresse) {
		this(nom, prenom, email, adresse, null);
	}
	public Client(int idClient, String nom, String prenom, String email, Adresse adresse) {
		this(nom, prenom, email, adresse, null);
		this.idClient = idClient;
	}
	public Client(String nom, String prenom, String email, Adresse adresse, Set<Commande> commandes) {
		super();
	...
	public Client setClient(int id, String nom, String prenom, String email, String nomVoie, String typeVoie, String numeroVoie, int codePostal, String ville) {
		Adresse adresse = new Adresse(nomVoie, typeVoie, numeroVoie, codePostal, ville);
		Client client = new Client(id, nom, prenom, email, adresse);
		return client;
	}
}
